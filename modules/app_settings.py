class AppSettings:
    def __init__(self, config: dict):
        ...
        self.completions_openai_embedding_model_deployment = config[
            'COMPLETIONS_OPENAI_EMBEDDING_MODEL_DEPLOYMENT']
        self.completions_openai_completion_model_deployment = config[
            'COMPLETIONS_OPENAI_COMPLETION_MODEL_DEPLOYMENT']
